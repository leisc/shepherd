...
# The shared `support` doubles resolve via `pythonpath` declared in both the root
# and dialect pytest config (see those notes) — no conftest sys.path.insert, which
# was ordering-fragile under aggregate collection.
